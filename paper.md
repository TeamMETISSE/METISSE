...
METISSE has already been employed in several scientific publications. For instance, it has also been used to demonstrate the impact of core overshooting — one of the major uncertainties in stellar evolution — on the evolutionary outcomes of binary systems[@Agrawal:2023]. Additionally, it has been used with stellar models from MESA as well as models from the Bonn Code (via the BoOST project [@Szecsi:2022]) to conduct a systematic study study of how different physical parameters affect the evolutionary properties of massive single stars [@Agrawal:2020].
